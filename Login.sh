...
echo -e "\e[1;32m
            ──▄▀▀▀▄───────────────
           \033[33mPlease Login To Continue Hacker buddy 🦇🕸\033[32m
            ──█───█───────────────
            ─███████─────────▄▀▀▄─
            ░██─▀─██░░█▀█▀▀▀▀█░░█░
            ░███▄███░░▀░▀░░░░░▀▀░░
...
\e[0m"
echo
read -p $'       \e[33m\033[1m\033[33m[\033[31m+\033[33m] \033[37mYOUR\033[33mUSERNAME >>>>:\033[32m ' user
read -s -p $'       \e[32m\033[1m\033[33m[\033[31m+\033[33m] \033[37mYOUR \033[33mPASSWORD>>>> :\033[33m ' pass                                                
...
╚═╝  ╚═╝╚═╝  ╚═╝ ╚═════╝╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝ 
"
echo -e  "     \e[1m\e[32m▂▃▄▅▆▇▓▒░ \033[1mCoded By \e[33mMr Babar\e[1m\e[32m░▒▓▇▆▅▄▃▂"
cd $HOME
cd Termux-Login
cd NETWORK
python network.py
echo -e "   \033[1m\033[33m]\033[31m──────────────────Mr Babar.com──────────────\033[33m["
echo 
